        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormSubmissions_Quizzes_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionResponses_FormSubmissions_FormSubmissionId",
                        column: x => x.FormSubmissionId,
                        principalTable: "FormSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionResponses_QuestionOptions_ChosenOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormSubmissions_QuizId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionResponses_ChosenOptionId",
                table: "QuestionResponses",
                column: "ChosenOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionResponses_FormSubmissionId_QuestionId",
                table: "QuestionResponses",
                columns: new[] { "FormSubmissionId", "QuestionId" },
                unique: true);
